...
$q. Characterise the environment (is it static or dynamic, deterministic or
stochastic, ...) according to all 6 properties mentioned on slide 13 (Agents) or
section 2.3.2 in the book!
